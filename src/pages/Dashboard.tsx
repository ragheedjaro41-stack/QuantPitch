...
export default function Dashboard() {
  ...
  return (
    <div className="px-4 sm:px-8 py-6 sm:py-8 max-w-7xl mx-auto">
      ...
      {/* Top scorers / Top assists / Top rated */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card p-6 flex flex-col justify-between">
          <div>
            <h2 className="text-base font-semibold text-white">League Average Rating</h2>
            <p className="text-xs text-slate-500 mt-1">Across all rated players this season</p>
          </div>
